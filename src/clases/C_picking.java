...
public class C_picking {
    ...
    public ArrayList<Nodo_picking> registropicking(int idst, int pedido, String producto, int cantidad, String estado ) throws SQLException{
       ...
       /*creamos un nuevo objeto Nodo_picking utilizando
    ...
    try {
        /*definimos una consulta SQL parametrizada que selecciona el campo "cantidadproducto" 
        de la tabla "picking" */
        ...
        /*asignamos los valores de las variables a los marcadores de posición*/
